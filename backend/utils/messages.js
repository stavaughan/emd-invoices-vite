...
const messages = {
  missingAuthToken: () =>
    noAccessWrapper(
      'No Access',
      'No authorization token provided or wrong token sent.',
      '401 Unauthorized'
    ),
  ...
  controllers: {
    users: {
      ...
      noActiveAccount:
        'The credentials provided do not belong to an active user account.',
      provideDifferentPW:
        'You must provide a different password than your existing one.',
      ...
      missingEM:
        'Access Forbidden! The email provided is not associated with a user for this account. You must, first, request permission from this accounts owner/admin so that your email can be added to the approved email list before you can register as a new user.',
      ...
      missingEM_NPW_PPW:
        'Please provide email, new password and the password you received in your email.',
      ...
      notApprovedEmail:
        'Access denied! The email entered is not on the approved list. Please contact application administrator to have your email placed on the list.',
      tempPWnoMatch:
        'The temporary password you entered does not with the one sent to you!',
      badServerNoUser: `Problem with server, user couldn't be created at this time`,
      invalidRole:
        'Access Denied! The role attached to your user account is an invalid role. Please contact application administrator to have your role updated.',
      deletedUser: (id, email) =>
        `User with id: ${id} has been deleted and email: ${email} has been removed from the approved email list.`,
      deletedUserError: (id) =>
        `User with id: ${id} could not be deleted and email might not have been removed either.`,
      roleNotAuthorized: (role) =>
        `Access Denied! Requested role, ${role}, is not an approved role for this application.`,
      ...
      failedToSendActivation: (userID) =>
        `Error! Failed to send activation request to user ${userID}`,
    ...
    collections: {
      ...
      fieldNotFound: (field) =>
        `Failed to locate item with the field value of ${field}.`,
      ...
      updateItems: (ids) =>
        `Failed to update! The requested items with the id numbers of ${ids}, were not found.`,
      deleteItemError: (id) =>
        `Failed to delete!\nThe requested item with the id number of ${id}, was not found.`,
      deleteItemsError: (ids) =>
        `The items with the following id numbers were not found: ${ids}.`,
      deleteItemSuccess: (id) =>
        `The requested item with the id number of ${id}, was succesfully deleted.`,
      deleteItemsSuccess: (ids) =>
        `The items with the following id numbers were succesfully deleted: ${ids}.`,
    },
  },
};
