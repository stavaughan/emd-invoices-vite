...
const documentsController = {
  ...
  deleteFile: asyncHandler(
    async (req, res) => await fileUpload.deleteS3File(req, res)
  ),
  ...
  getFile: asyncHandler(
    async (req, res) => await fileUpload.getS3File(req, res)
  ),
  ...
  upLoadFile: asyncHandler(
    async (req, res) => await fileUpload.upLoadS3File(req, res)
  ),
};
