...
import { resetImages, uploadInvoiceImage } from '@/features/images/imagesSlice';
				...
				<Col cols="12 sm-6">
					<UploadImageContainer
						ids={{
							contact: 'new',
							toast: 'newInvoiceImg',
							pid: selector?.invoiceImageID
								? `invoice-images/${selector?.invoiceImageID}` : '',
							idType: "invoice"
						}}
						selector={selector}
						collection="invoices"
						uploadImageID={selector?.invoiceImageID}
						updateImage={updateImage}
						uploadSlice={uploadInvoiceImage}
